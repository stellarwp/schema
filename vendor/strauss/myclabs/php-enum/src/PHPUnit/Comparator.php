...
namespace StellarWP\Schema\MyCLabs\Enum\PHPUnit;

use StellarWP\Schema\MyCLabs\Enum\Enum;
 ...
 *
 * \SebastianBergmann\Comparator\Factory::getInstance()->register(new \StellarWP\Schema\MyCLabs\Enum\PHPUnit\Comparator());
 */
